...
class TeachViewController: UIViewController {
    ...
    func updateLanguage() {
        ...
        case .English:
            ...
            page3Label.text = "Choose your \"Fast attack\" and \"Charge attack\", different combinations let you know that your pekemon ability.\n\nChoose opponent, Will simulate the fight until your blood is 0. Attack and Defensive values are percent of opponent's HP, touch the value you can see battle details."
            page4TitleLabel.text = "THE FORMULA?"
            page4Label.text = "<Become Attacker>\nCharge attack Seconds +0.5\n-2 HP = +1 energy\n\n<Become Defender>\nAll attacks Seconds + 2.0\n-2 HP = +1 energy, HP x 2\n\nDamage = Floor(½ Power * Attacker's_Attack/Defender's_Defense * STAB * Effectiveness)+ 1"

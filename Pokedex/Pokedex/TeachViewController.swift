...
class TeachViewController: UIViewController {
    ...
    func updateLanguage() {
        ...
        case .Chinese, .Austrian:
            ...
            page1Label.text = "每隻寶可夢，擁有該種類基礎的\"攻擊、防禦、體力\"值之外，這三種值每種還會再附加0-15的數值，就是所謂的IV值。\n\nCP值就是由當前寶可夢等級(曲線角度)，再由攻擊、防禦、體力值計算而來，強化一次使得你的寶可夢等級+0.5，當寶可夢的同等級(曲線角度)時，IV越高會使得計算出的CP值越高。"
            ...
            page3Label.text = "選擇\"快速攻擊\"及\"蓄力攻擊\"，不同的技能組合影響你的寶可夢在進攻道館跟防守道館的能力。\n\n選擇後會立刻根據你的能力值及技能計算在進攻道館及防守道館\"60秒總傷害值\"，預設對手皆為 Lv.20 皮卡丘(IV Max)。"
